...
import {
  ...
  updateTransaction,
  deleteTransaction,
} from "./store.transaction.controller.js";
import { isLoggedIn } from "../../core/middleware/isLoggedIn.js";

const storeTransactionRouter = Router();

storeTransactionRouter.post("/", isLoggedIn, validate(StoreTransaction), createTransaction);
storeTransactionRouter.get("/", isLoggedIn, getAllTransactions);
storeTransactionRouter.get("/:id", isLoggedIn, getTransactionById);
storeTransactionRouter.put("/:id", isLoggedIn, validate(StoreTransaction.partial()), updateTransaction);
